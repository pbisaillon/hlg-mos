...
satgpa <-
  readr::read_csv("/Documents and Settings/vongbri/Documents/Hackathon/hlg-mos/data/satgpa.csv") %>%
  select(-sat_sum)

synth_bisaillon <-
  readr::read_csv(
    "/Documents and Settings/vongbri/Documents/Hackathon/hlg-mos/synthpop/synth_data.csv"
  )
