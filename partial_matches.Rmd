...
If a record is fully replicated in the synthetic data, it is effectively disclosed. This might not be serious, but it is still good to be aware of these matches.

Thankfully this is easy to do in R. An inner-join of the original and synthetic data will quickly return all rows that match 100%.
